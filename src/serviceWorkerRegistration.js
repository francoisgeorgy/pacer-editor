...
export function register(config) {
    ...
    console.log("serviceWorkerRegistration.register()", process.env.NODE_ENV, 'serviceWorker' in navigator);
    ...
    if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
        ...
        window.addEventListener('load', () => {
            ...
            if (isLocalhost) {
                ...
                console.log("register service-worker.js: running on localhost");
